...
namespace BerkutBot.Games.Game9
{
    public class Game9AnswerGo : IGameAnswer
    {
        ...
        public async Task<string> Reply(Message message)
        {
            ...
            await SendSecondPart(message);

            return REPLY_TEXT;
        }

        private async Task SendSecondPart(Message message)
        {
            try
            {
                var announcement = new AnnouncementRequest()
                {
                    ...
                    Announcement = new Announcement
                    {
                        ...
                        ContentUrl = new Uri("https://sawevprivate.blob.core.windows.net/public/Game9/game9_q1_2.mp4")
                    }
                };
