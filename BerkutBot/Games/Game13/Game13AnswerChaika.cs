...
{
    public class Game13AnswerChaika : IGameAnswer
    {
        ...
        private readonly ILogger<Game13AnswerChaika> _logger;
        private readonly IAnnouncementScheduler _announcementScheduler;

        public Game13AnswerChaika(ITelegramBotClient telegramBotClient,
            ILogger<Game13AnswerChaika> logger,
        ...
        public async Task<string> Reply(Message message)
        {
            await _telegramBotClient.SendPhotoAsync(
                ...
                photo: InputFile.FromString("https://sawevprivate.blob.core.windows.net/public/Game13/point2.jpg"),
                caption: "59.845397, 30.379298");
