...
namespace BerkutBot.Games.Game11.StartCommands
{
	...
	{
        private const string ANSWER = "Point5_ca07c1ab-c4f8-4e20-8c7f-008777a0fa51";
        ...
        public async Task<string> Reply(Message message)
        {
            await _telegramBotClient.SendPhotoAsync(
                ...
                photo: InputFile.FromString("https://sawevprivate.blob.core.windows.net/public/Game11/Pic3.jpg"));
