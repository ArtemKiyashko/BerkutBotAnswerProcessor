...
{
    public class Game7HelpCommandHandler : IGameAnswer
    {
        ...
        private readonly ILogger<Game7HelpCommandHandler> _logger;

        public Game7HelpCommandHandler(ITelegramBotClient telegramBotClient, ILogger<Game7HelpCommandHandler> logger)
        {
