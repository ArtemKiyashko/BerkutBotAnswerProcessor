...
{
    public class Game6HelpCommandHandler : IGameAnswer
    {
        ...
        private readonly ILogger<Game6HelpCommandHandler> _logger;

        public Game6HelpCommandHandler(ITelegramBotClient telegramBotClient, ILogger<Game6HelpCommandHandler> logger)
        {
