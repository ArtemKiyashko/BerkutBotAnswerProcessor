...
{
    public class Game8HelpCommandHandler : IGameAnswer
    {
        ...
        private readonly ILogger<Game8HelpCommandHandler> _logger;

        public Game8HelpCommandHandler(ITelegramBotClient telegramBotClient, ILogger<Game8HelpCommandHandler> logger)
        {
