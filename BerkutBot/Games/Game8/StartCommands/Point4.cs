...
namespace BerkutBot.Games.Game8.StartCommands
{
	...
	{
        private const string ANSWER = "Point4_03b83ee9-cadd-4dbe-b4c3-3e3d0b1679fd";
        private const string PUBLIC_CONTAINER = "public";
        private const string BLOB_PATH = "Game8/point4.mp3";
            ...
            try
            {
                var announcement = new AnnouncementRequest()
                {
                    ...
                    Announcement = new Announcement
                    {
                        ...
                        ContentUrl = new Uri("https://sawevprivate.blob.core.windows.net/public/Game8/jokes/joke2.mp4"),
                        Text = "Прочитал прохождение задания про точку старта"
                    }
                };
