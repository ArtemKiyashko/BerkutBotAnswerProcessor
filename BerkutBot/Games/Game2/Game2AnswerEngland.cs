...
{
	public class Game2AnswerEngland : IGameAnswer
	{
        ...
        private const string PICTURE_BLOB = "england.jpg";
        private readonly HashSet<string> _answerSet = new() { "англия", "england", "united kingdom" };

        private readonly ITelegramBotClient _telegramBotClient;
        private readonly BlobServiceClient _blobServiceClient;
        private readonly ILogger<Game2AnswerEngland> _logger;

        public Game2AnswerEngland(ITelegramBotClient telegramBotClient, BlobServiceClient blobServiceClient, ILogger<Game2AnswerEngland> logger)
		{
