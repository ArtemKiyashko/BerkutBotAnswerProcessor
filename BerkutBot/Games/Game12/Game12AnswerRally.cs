...
{
    public class Game12AnswerRally : IGameAnswer
    {
        ...
        private readonly ILogger<Game12AnswerRally> _logger;
        private readonly IAnnouncementScheduler _announcementScheduler;
        private readonly BlobServiceClient _blobServiceClient;

        public Game12AnswerRally(ITelegramBotClient telegramBotClient,
            ILogger<Game12AnswerRally> logger,
