...
namespace BerkutBot.Games.Game12.StartCommands
{
	...
	{
        private const string ANSWER = "Point4_fb74fbea-ece6-4b20-bcdb-4278ec9c7662";
        ...
        public async Task<string> Reply(Message message)
        {
            await _telegramBotClient.SendPhotoAsync(
                ...
                photo: InputFile.FromString("https://sawevprivate.blob.core.windows.net/public/Game12/point4.png"));
