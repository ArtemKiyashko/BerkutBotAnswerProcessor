...
namespace BerkutBot.Games.Game12.StartCommands
{
	...
	{
        private const string ANSWER = "Point12_e676e724-69de-4625-8ec9-6f0cbd083e41";
        ...
        public async Task<string> Reply(Message message)
        {
            ...
            var mediaGroup = new List<InputMediaPhoto> {
                new InputMediaPhoto(InputFile.FromString("https://sawevprivate.blob.core.windows.net/public/Game12/lenta_cosmos.png")),
                new InputMediaPhoto(InputFile.FromString("https://sawevprivate.blob.core.windows.net/public/Game12/lenta_balt.png"))
            };
