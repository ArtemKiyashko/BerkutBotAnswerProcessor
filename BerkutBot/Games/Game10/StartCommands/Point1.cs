...
namespace BerkutBot.Games.Game10.StartCommands
{
	...
	{
        private const string ANSWER = "Point1_33a69ded-7777-49c9-bfaa-5129128a7610";
        ...
        public async Task<string> Reply(Message message)
        {
            await _telegramBotClient.SendPhotoAsync(
                ...
                photo: InputFile.FromString("https://sawevprivate.blob.core.windows.net/public/Game10/point1.jpeg"),
                caption: "https://berkut.ar");
